 ...
 */
MouvementComponent::MouvementComponent(float dirX, float dirY, float speed)
    : _dirX(dirX)
    , _dirY(dirY)
    , _speed(speed)
{
 ...
 */
void MouvementComponent::setDirX(float x) noexcept
{
    _dirX = x;
}
 ...
 * 
 * @param y The y-axis direction of the movement.
 */
void MouvementComponent::setDirY(float y) noexcept
{
    _dirY = y;
}
